...
class MovieRecommender:
    """A movie recommender class that uses a collaborative filtering model defined in CFmodel class"""
    def __init__(self):
    ...
    def load_data(self):
        """ Load the data and combine movies, users into one DataFrame. """
        # Load users dataset
    ...
    def build_regularized_model(self, embedding_dim=3, regularization_coeff=.1, gravity_coeff=1.,
        init_stddev=0.1):
        """
        Build a regularized collaborative filtering model.
        Args:
    ...
    def movie_tsne(self, model):
        """ Visualize movie embedding with TSNE. """
    ...
    def plt_tsne(self, selected_categories, reg):
        """ Plot TSNE of the movie embedding. """
